                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-400">
                        MXN {(dispute.project_id?.amount ?? 0).toLocaleString()}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-300">
                      ...
                      ID: {String(dispute.project_id?.freelancer_id ?? '').substring(0, 8)}...
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-300">
                      {/* TODO: Get recruiter name */}
                      ID: {String(dispute.project_id?.recruiter_id ?? '').substring(0, 8)}...
                    </div>
                  </td>
