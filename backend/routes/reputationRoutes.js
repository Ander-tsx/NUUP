...
const {
    getReputationByPublicKey, getReputationByUserId, checkBanned, shadowbanUser, unbanUser,
    addReputationOnChain, removeReputationOnChain,
} = require('../controllers/reputationController');
const router = express.Router();
router.get('/user/:userId', getReputationByUserId);   // DB-backed — must be before /:publicKey
